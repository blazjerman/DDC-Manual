...
LTspice capture of the multiplexing signal used to switch between the display digits. This was not measured on the real circuit because I did not have enough oscilloscope probes. In the real circuit, the IC behaves similarly, but with much smaller spikes due to wire capacitance and inductance.
...
<video controls width="100%">
  <source src="images/multiplexing_additional_cap.mp4" type="video/mp4">
...
<video controls width="100%">
  <source src="images/esp32_wifi_clock_setter.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
